    ...
    <div className="fixed md:bottom-8 bottom-4 right-0 poppins cursor-pointer">
     {isChatbotOpen && (
        ...
        >
          ...
          {isChatbotOpen && (<div className="md:mr-20 mr-14 p-3">
            <p className="font-medium text-sm md:text-lg">Ask smart questions, Boss!</p>
            <p className="text-sm text-[var(--lgold)] hidden md:inline-block">Click here to shut me up!</p>
          </div>)}
