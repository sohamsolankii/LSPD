                ...
                <div>
                    <div className="max-w-[100%] mx-auto bg-[var(--bg1l)]  mt-20 dark:bg-[var(--dbg1l)] text-[var(--lgold)] dark:text-[var(--dltext)] shadow-lg dark:shadow-sm rounded-lg md:rounded-2xl overflow-hidden">
                        <div className="block md:flex p-3">
                            <button onClick={handleBack} className="m-3 bg-blue-500 poppins text-white px-4 h-10 rounded-md">Back to News</button>
                            <h2 className="md:text-4xl text-xl pricedown text-center m-2">{selectedArticle.headline}</h2></div>
                        <img src={selectedArticle.image} alt={selectedArticle.headline} className="w-full rounded-xl p-4 object-cover" />
