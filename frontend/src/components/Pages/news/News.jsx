...
const News = () => {
    ...
    return (
        <div className="w-full bg-[var(--bg1)] dark:bg-[var(--dbg1)] mx-auto p-4 md:p-10">
            {selectedArticle ? (
                <div>
                    <div className="max-w-[100%] mx-auto bg-[var(--bg1l)]  mt-20 dark:bg-[var(--dbg1l)] text-[var(--lgold)] dark:text-[var(--dltext)] shadow-lg dark:shadow-sm rounded-lg md:rounded-2xl overflow-hidden">
                        <div className="block md:flex p-3">
                            <button
                                onClick={handleBack}
                                className="m-3 bg-blue-500 poppins text-white px-4 h-10 rounded-md"
                            >
                                Back to News
                            </button>
                        ...
                        <img
                            ...
                            className="w-full rounded-xl p-4 object-cover"
                        />
                        ...
                        <div className="p-4 poppins text-sm">
                            <div className="md:flex block justify-center">
                                <button
                                    ...
                                    className="bg-blue-500 text-white h-9 px-2 py-1 mr-5 mb-2 md:mb-4 md:mr-20 rounded-md"
                                >
                                ...
                                <div>
                                    ...
                                    <button
                                        ...
                                        className="bg-blue-500 text-white h-9 px-2 py-1 rounded-md"
                                    >
                                        Comment
                                    </button>
                                </div>
                ...
                <div classname=" mt-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
                        {articles.map((article) => (
                            <div
                                key={article.id}
                                className="bg-[var(--bg1l)] dark:bg-[var(--dbg1l)] hover:bg-[var(--hover-bg-gradient-end)] hover:dark:bg-[var(--dllgold)] text-[var(--ltext)] dark:text-[var(--dlblue)] hover:text-[var(--lgold)] hover:dark:text-[var(--dltext)] shadow-lg dark:shadow-sm rounded-lg md:rounded-2xl overflow-hidden cursor-pointer p-3 md:p-4 transition ease-in-out duration-1500"
                                onClick={() => handleClick(article)}
                            >
                                <img
                                    src={article.image}
                                    alt={article.headline}
                                    className="w-full md:h-52 h-30 md:rounded-md rounded-sm shadow-sm object-cover"
                                />
