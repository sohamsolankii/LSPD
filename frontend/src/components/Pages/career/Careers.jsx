            ...
            <div className="mb-6 rounded-2xl shadow-black/70 dark:shadow-black/10 bg-[var(--bg1)] dark:bg-gray-100 dark:border-gray-400 border-[1px] border-[var(--opac)] shadow-2xl">
                ...
                <div className="p-5">
                    ...
                    {/* <div className="inline-flex items-center justify-center w-full">
                        ...
                        <span className="absolute px-3 font-medium text-[var(--lgold)] -translate-x-1/2 bg-[var(--bg1)] left-1/2 dark:text-[var(--dltext)] dark:bg-gray-100">
                            Explore Careers
                        </span>
                    </div> */}
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {filteredJobs.map((job) => (
                            <div
                                key={job.id}
                                className="p-4 bg-[var(--opac)] dark:bg-gray-100 border-[1px] border-[var(--opac)] dark:border-gray-300 rounded-md shadow-black/30 dark:shadow-none shadow-md"
                            >
                                <h3 className="md:text-lg text-md font-medium text-gray-200 dark:text-[var(--dltext)]">
                                    {job.title}
                                </h3>
            ...
            {/* {selectedJob && (
                <div className="fixed inset-0 text-gray-300 dark:text-gray-600 flex items-center justify-center z-10">
                    <div className="bg-[var(--opac)] backdrop-blur-3xl border-[1px] border-[var(--opac)] animate-appear blockanim dark:border-gray-400 md:p-6 p-3 rounded-xl lg:w-[85%] shadow-black/80 dark:shadow-black/40 shadow-2xl w-[94%]">
                        ...
                        <button className="mt-4 ml-2 text-green-500 px-4 py-1 shadow-black/40 border-[1px] hover:text-white border-green-500 dark:shadow-black/10 dark:shadow-md shadow-xl rounded-full hover:bg-green-700">
                            Apply | {selectedJob.contactEmail}
                        </button>
                    </div>
                </div>
            )} */}
