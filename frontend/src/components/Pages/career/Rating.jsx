...
const Rating = () => {
    return (
        <div><div className="flex items-center mb-2">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">4.95</p>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 ms-1">out of</p>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 ms-1">5</p>
        </div>
