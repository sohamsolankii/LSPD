        ...
        <div className="bg-[var(--bg1)] text-[var(--lblue)] min-h-screen">
            ...
            <section className="p-12">
                <div className="text-center m-8 p-12">
                    <h2 className="text-5xl pricedown font-bold text-[var(--lblue)] mb-4">
                        Welcome to LSPD Eagle-eye
                    </h2>
                    <p className="text-2xl poppins mb-2 text-[var(--ltext)]">
                ...
                <div className="bg-[var(--bg1l)] p-12 rounded-2xl shadow-2xl text-left mt-10 mb-10 mx-4 md:mx-20">
                    <h3 className="text-4xl pricedown text-[var(--lgold)] font-bold">
                        Why LSPD Eagle-eye?
                    </h3>
                    ...
                    <p className="mb-8 text-[var(--ltext)] text-xl">
