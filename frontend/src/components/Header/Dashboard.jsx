        ...
        <div className="bg-[var(--bg1)] text-[var(--lblue)] min-h-screen">
            <section className="p-12">
                <div className="text-center m-8 p-12">
                    <h2 className="text-5xl pricedown font-bold text-[var(--lblue)] mb-4">Welcome to LSPD Eagle-eye</h2>
                    <p className="text-2xl poppins mb-2 text-[var(--ltext)]">Your Digital Hotline for All Things Los Santos! (Yes, Even the Crazy Stuff)</p>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-10 pr-4 md:px-20">
                    {dashboardData.map((item, index) => (
                        <div key={index} className="flex bg-[var(--bg1l)] p-3 rounded-2xl shadow-2xl text-left items-center transform transition-transform duration-300 hover:scale-105 hover:border-[var(--hover-border-color)] hover:border-2 hover:bg-gradient-to-r from-[var(--hover-bg-gradient-start)] to-[var(--hover-bg-gradient-end)]">
                ...
                <div className="bg-[var(--bg1l)] p-12 rounded-2xl shadow-2xl text-left mt-10 mb-10 mx-4 md:mx-20">
                    <h3 className="text-4xl pricedown text-[var(--lgold)] font-bold">Why LSPD Eagle-eye?</h3>
                    <p className="my-8 text-[var(--ltext)] text-xl">
                    ...
                    <p className="mb-8 text-[var(--ltext)] text-xl">Join us in keeping Los Santos safe and lively, one tip at a time!</p>
